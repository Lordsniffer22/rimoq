...
async def help_msg(message: Message):
    ...
    msg = (f'✈️<b>OCTOPAS PANEL V1.2</b>😐🤩\n\n'
           ...
           f'➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖\n\n'
           f'Resellers Have the right to sell server accounts or files from any of our premium servers. We give a huge bundle of servers at a very small price, starting with $9.\n\n<i><b>We only charge you a small set up fee $0.4 for each user you create</b></i>')

    msg1 = (f'✈️<b>OCTOPAS ADMIN V1.2</b>😐🤩\n\n'
           f'To refresh this bot, send /start\n➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖\n\n'
